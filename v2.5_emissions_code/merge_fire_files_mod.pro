pro merge_fire_files_mod
 ...
 for year = 2002,2020 do begin
  ...
  file_withpoly = path_fires+'out_global_mod_'+syr+'_modlct_'+syrprev+'_modvcf_'+syrprev+'_regnum.csv'
  file_without = path_fires_nopoly+'out_global_mod_'+syr+'_no_lrg_poly_modlct_'+syrprev+'_modvcf_'+syrprev+'_regnum.csv'
  file_new = path_fires_nopoly+'fires_mod_merged_'+syr+'.csv'

  file_log = 'log_mod_merged_'+syr+'.out'
